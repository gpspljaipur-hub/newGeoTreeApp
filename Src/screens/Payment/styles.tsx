...
export const styles = StyleSheet.create({
  ...
  summaryCard: {
    ...
    borderRadius: 24,
    marginHorizontal: MarginHW.MarginW16,
    paddingTop: MarginHW.PaddingH18,
    paddingBottom: MarginHW.PaddingH22,
  ...
  amountIconContainer: {
    ...
    borderRadius: ImageSize.ImageW26 / 2,
  ...
  payButton: {
    ...
    height: HWSize.H_Height62,
    borderRadius: HWSize.H_Height62 / 2,
    alignItems: 'center',
    justifyContent: 'center',
