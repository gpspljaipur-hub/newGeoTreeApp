...
const ReviewPlantationScreen = () => {
  ...
  const impactItems = [
    { id: '1', value: `${qty} Trees`, label: 'Planted', icon: Images.treeIcon },
    { id: '2', value: `${co2} KG`, label: 'CO₂ / Year', icon: Images.co2Cloud },
    { id: '3', value: 'GPS Tagged', label: 'Verified', icon: Images.location },
    { id: '4', value: 'Quarterly', label: 'Growth Updates', icon: Images.plant },
    ...
    <SafeAreaView style={styles.container} edges={['left', 'right']}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
              ...
              <View style={styles.stepItem}>
                <View style={styles.stepCircleContainer}>
                  <View style={[styles.stepCircle, styles.stepCircleActive]}>
                    <Image source={Images.lock} style={[styles.stepIcon, styles.stepIconActive]} resizeMode="contain" />
                  </View>
                </View>
          ...
          <View style={styles.heroSection}>
            <View style={styles.heroTitleRow}>
              <Text style={styles.heroTitle}>
                Review Your <Text style={styles.heroTitleGreen}>Plantation</Text>
              </Text>
        ...
        <View style={styles.sectionContainer}>
          <View style={styles.sectionTitleRow}>
            <View style={styles.sectionTitleLeft}>
              <Image source={Images.heart} style={styles.sectionTitleIcon} resizeMode="contain" />
              <Text style={styles.sectionTitle}>Dedication Summary</Text>
            </View>
          </View>

          <View style={styles.dedicationCard}>
            {/* Left Col: Dedicated to & message */}
            <View style={styles.dedicationColumn}>
              ...
              <Text style={styles.dedicationLabel}>Message</Text>
            ...
            {/* Right Col: Tree allocation list */}
            <View style={styles.dedicationColumnRight}>
              <Text style={styles.dedicationLabel}>Tree Allocation</Text>
        ...
        <View style={styles.sectionContainer}>
          <View style={styles.sectionTitleRow}>
            <View style={styles.sectionTitleLeft}>
              <Image source={Images.globe} style={styles.sectionTitleIcon} resizeMode="contain" />
          ...
          <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.impactScroll}>
            {impactItems.map(item => (
              <View key={item.id} style={styles.impactItemCard}>
                <View style={styles.impactItemIconBg}>
                ...
                <View style={styles.paymentMethodDetails}>
                  ...
                  {selectedMethod === 'upi' && (
                    <View style={styles.upiLogosRow}>
                      <View style={[styles.upiLogoBox, { borderLeftColor: '#5F259F', borderLeftWidth: 2 }]}>
                        <Text style={[styles.upiTextLogo, { color: '#5F259F' }]}>PhonePe</Text>
                      </View>
                      <View style={[styles.upiLogoBox, { borderLeftColor: '#4285F4', borderLeftWidth: 2 }]}>
                        <Text style={[styles.upiTextLogo, { color: '#4285F4' }]}>G Pay</Text>
                      </View>
                      <View style={[styles.upiLogoBox, { borderLeftColor: '#00B9F5', borderLeftWidth: 2 }]}>
                        <Text style={[styles.upiTextLogo, { color: '#002970' }]}>Paytm</Text>
                      </View>
                      <View style={[styles.upiLogoBox, { borderLeftColor: '#0F7F1B', borderLeftWidth: 2 }]}>
